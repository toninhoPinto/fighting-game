...
impl GameInput {
    pub fn init_input_state() -> [(GameInput, bool); 10] {
        let mut current_inputs_state: [(GameInput, bool); 10] =
            [(GameInput::LightPunch, false); 10];
    ...
    pub fn get_button_index(
        current_inputs_state: &mut [(GameInput, bool); 10],
        input: GameInput,
    ) -> usize {
    ...
    pub fn merge_horizontal_vertical(
        input_1: GameInput,
        input_2: GameInput,
    ) -> Result<GameInput, &'static str> {
        if (input_1 == GameInput::Forward && input_2 == GameInput::Up)
            || (input_2 == GameInput::Forward && input_1 == GameInput::Up)
        {
            Ok(GameInput::ForwardUp)
        } else if (input_1 == GameInput::Backward && input_2 == GameInput::Up)
            || (input_2 == GameInput::Backward && input_1 == GameInput::Up)
        {
            Ok(GameInput::BackwardUp)
        } else if (input_1 == GameInput::Forward && input_2 == GameInput::Down)
            || (input_2 == GameInput::Forward && input_1 == GameInput::Down)
        {
            Ok(GameInput::ForwardDown)
        } else if (input_1 == GameInput::Backward && input_2 == GameInput::Down)
            || (input_2 == GameInput::Backward && input_1 == GameInput::Down)
        {
