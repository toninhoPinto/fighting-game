...
use super::{character_factory::CharacterAssets, characters::{Character, player::PlayerState}, game::Game, projectile::Projectile};
...
impl SavedGame {
    ...
    pub fn save(game: &Game) -> Self{
        Self{
            ...
            p1_name: game.player1.animator.current_animation.unwrap().name.clone(),
            ...
            p2_name: game.player2.animator.current_animation.unwrap().name.clone(),
    ...
    pub fn load<'a>(&self, game: &mut Game<'a>, p1_assets: &'a CharacterAssets, p2_assets: &'a CharacterAssets) {
